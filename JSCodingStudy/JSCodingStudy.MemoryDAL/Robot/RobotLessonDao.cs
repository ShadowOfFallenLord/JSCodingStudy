...
namespace JSCodingStudy.MemoryDAL.Robot
{
    public class RobotLessonDao : LessonDao<RobotLessonData>
    {
        ...
        {
            yield return Lesson1;
            yield return Lesson2;
            yield return Lesson3;
            yield return Lesson4;
            yield return Lesson5;
        }

        // Lesson 1 - Передвижение 1
        public static readonly RobotLessonData Lesson1 = new RobotLessonData
        {
            Id = 1,
        ...
        public static readonly RobotLessonData Lesson2 = new RobotLessonData
        {
            Id = 2,
        ...
        public static readonly RobotLessonData Lesson3 = new RobotLessonData
        {
            Id = 3,
        ...
        // Lesson 4 - Цикл for 1
        public static readonly RobotLessonData Lesson4 = new RobotLessonData
        {
            Id = 4,
            ...
            Task = "Если нужно выполнить некоторый набор операций определенное количество раз, можно использовать цикл for со следующим синтаксисом:\n" +
                   ...
                   "Здесь:\n" +
                   "-- var i = 1 - обявление счетчика i с начальным значением 1,\n" +
        ...
        // Lesson 5 - Цикл for 2
        public static readonly RobotLessonData Lesson5 = new RobotLessonData
        {
            Id = 5,
